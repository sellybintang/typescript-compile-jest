...
describe('array', function () {
    it('is array ', function () {
        const nama_penduduk = ["Selly", "Fajar", "Ajeng"];
        const nama_penduduk1 = ["Selly", "Fajar", "Ajeng"];
        const umur_penduduk = [20, 20, 20];
        const hapus_penduduk = [false, true, false];
